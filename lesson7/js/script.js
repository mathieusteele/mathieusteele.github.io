...
document.querySelectorAll("#day-three").innerText = dayThree.toLocaleDateString(
  "en-US",
  {
    weekday: "long",
  }
...
document.querySelectorAll("#day-four").innerText = dayFour.toLocaleDateString(
  "en-US",
  {
    weekday: "long",
  }
...
document.querySelectorAll("#day-five").innerText = dayFive.toLocaleDateString(
  "en-US",
  {
    weekday: "long",
  }
